...
(function () {
  ...
  var FALLBACK = [
    ...
    { catalog_id: 'dnd_skills', name: 'D&D 5e Skills', domain: 'gaming', read_rate_usd: 0, is_real: true,
      description: 'D&D 5e skills — the governing ability and what each skill covers.' },
    { catalog_id: 'dnd_damage_types', name: 'D&D 5e Damage Types', domain: 'gaming', read_rate_usd: 0, is_real: true,
      description: 'D&D 5e damage types (acid, fire, slashing…) and what they represent.' },
    { catalog_id: 'dnd_weapon_properties', name: 'D&D 5e Weapon Properties', domain: 'gaming', read_rate_usd: 0, is_real: true,
      description: 'D&D 5e weapon properties (finesse, heavy, reach…) and what they do.' },
    { catalog_id: 'dnd_languages', name: 'D&D 5e Languages', domain: 'gaming', read_rate_usd: 0, is_real: true,
      description: 'D&D 5e languages — type, typical speakers and script.' },
    { catalog_id: 'ghibli_vehicles', name: 'Studio Ghibli Vehicles', domain: 'entertainment', read_rate_usd: 0, is_real: true,
      description: 'Vehicles from Studio Ghibli films — name, class, length and a description.' },
    { catalog_id: 'met_departments', name: 'Met Museum Departments', domain: 'art', read_rate_usd: 0, is_real: true,
      description: 'The curatorial departments of The Metropolitan Museum of Art.' },
    { catalog_id: 'top_characters', name: 'Top Anime Characters (Jikan)', domain: 'entertainment', read_rate_usd: 0, is_real: true,
      description: 'The most-favorited anime/manga characters — name, Japanese name and favorites count.' },
    { catalog_id: 'anime_people', name: 'Top Anime People (Jikan)', domain: 'entertainment', read_rate_usd: 0, is_real: true,
      description: 'Most-favorited anime voice actors, directors and staff with favorites count.' },
    { catalog_id: 'music_genres', name: 'Music Genres (Deezer)', domain: 'media', read_rate_usd: 0, is_real: true,
      description: 'The list of music genres on Deezer.' },
    { catalog_id: 'crypto_history', name: 'Crypto Price History (CoinGecko)', domain: 'crypto', read_rate_usd: 0, is_real: true,
      description: 'Daily historical USD price of a cryptocurrency over a recent window.' },
    { catalog_id: 'art_agents', name: 'Artists (Art Institute of Chicago)', domain: 'art', read_rate_usd: 0, is_real: true,
      description: 'Search artists — name, birth/death dates and a short biography.' },
